...
public class CheckHotels extends JFrame implements Runnable {
    ...
    public CheckHotels() {
        ...
        setBounds(250, 20, 900, 500);
        getContentPane().setBackground(new Color(220, 250, 250));
        
        th = new Thread(this);
    
        caption = new JLabel();
        caption.setBounds(250, 400, 1000, 70);
        ...
        l4 = new JLabel(i9);
        l4.setBounds(0, 0, 900, 500);
        add(l4);
        l4.setVisible(false);

        ImageIcon i10 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel4.jpg"));
        Image i11 = i10.getImage().getScaledInstance(900, 500, Image.SCALE_DEFAULT);
        ...
        Image i17 = i16.getImage().getScaledInstance(900, 500, Image.SCALE_DEFAULT);
        ImageIcon i18 = new ImageIcon(i17);
        l7 = new JLabel(i18);
        l7.setBounds(0, 0, 900, 500);
        add(l7);
        l7.setVisible(false);

        ImageIcon i19 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel7.jpg"));
        Image i20 = i19.getImage().getScaledInstance(900, 500, Image.SCALE_DEFAULT);
        ...
        Image i23 = i22.getImage().getScaledInstance(900, 500, Image.SCALE_DEFAULT);
        ...
        Image i26 = i25.getImage().getScaledInstance(900, 500, Image.SCALE_DEFAULT);
        ImageIcon i27 = new ImageIcon(i26);
        l10 = new JLabel(i27);
        l10.setBounds(0, 0, 900, 500);
        add(l10);
        l10.setVisible(false);

        ImageIcon i28 = new ImageIcon(ClassLoader.getSystemResource("icons/hotel10.jpg"));
        Image i29 = i28.getImage().getScaledInstance(900, 500, Image.SCALE_DEFAULT);
